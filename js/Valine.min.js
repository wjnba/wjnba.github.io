...
!function (e, t) {
  ...
  return function (e) {
    ...
    "use strict";
    var r = n(99), o = "function" == typeof Symbol && "symbol" == typeof Symbol("foo"), i = Object.prototype.toString,
...
*/
    ...
    var a = n(47), s = r(a), l = n(37), c = r(l), u = n(41), f = r(u), p = n(13), d = r(p), h = n(6), v = n(45),
      g = r(v), m = n(40), y = r(m), b = n(44), w = n(42), x = r(w), k = n(3), S = r(k), _ = n(43), A = r(_), O = n(46),
      j = r(O), $ = n(39),
      E = (r($), {comment: "", nick: "", mail: "", link: "", ua: S.default.ua, url: "", QQAvatar: ""}), T = "", I = {
    ...
    var z = function (e, t) {
      ...
      add: function (e, t) {
        ...
        if (1 === r.length) {
          var o = r[0], i = decodeURI((0, S.default)(o).attr("id")), a = (0, S.default)(o).attr("data-flag-title"),
          ...
          r.containedIn("url", n), r.find().then(function (e) {
            e.length > 0 && t.forEach(function (t) {
              e.forEach(function (e) {
                var n = e.get("xid") || encodeURI(e.get("url")), r = e.get("time"), o = (0, S.default)(t),
                  i = o.attr("id");
    ...
    o.prototype.Q = function (e) {
      ...
      var e = this, t = e.$el.find(".vemojis"), n = e.$el.find(".vpreview"), r = e.$el.find(".vemoji-btn"),
        o = e.$el.find(".vpreview-btn"), i = e.$el.find(".veditor"), a = d.default.maps, l = !1, u = function (e) {
          var n = [];
    ...
    t.default = function (e) {
      return e = (0, o.default)({url: "", method: "get", body: {}}, e), new Promise(function (t, n) {
        if ("jsonp" == e.method) {
          var r = "cb_" + (Date.now() + Math.round(1e3 * Math.random())).toString(32), o = document, i = o.body,
        ...
        var l = "XMLHttpRequest" in window ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"), c = [],
          u = [], f = {}, p = function e() {
            return {
              ok: 2 == (l.status / 100 | 0),
    ...
    "use strict";
    var r = n(0), o = r("%TypeError%"), i = r("%Number%"), a = r("%RegExp%"), s = r("%parseInt%"), l = n(1), c = n(80),
      u = n(78), f = l("String.prototype.slice"), p = c(/^0b[01]+$/i), d = c(/^0o[0-7]+$/i),
      h = c(/^[-+]0x[0-9a-f]+$/i), v = ["", "​", "�"].join(""), g = new a("[" + v + "]", "g"), m = c(g),
      y = ["\t\n\v\f\r   ᠎    ", "         　\u2028", "\u2029\ufeff"].join(""),
      b = new RegExp("(^[" + y + "]+)|([" + y + "]+$)", "g"), w = l("String.prototype.replace"), x = function (e) {
        return w(e, b, "")
      }, k = n(68);
    e.exports = function e(t) {
      var n = u(t) ? t : k(t, i);
    ...
    !function (t, n) {
      ...
      var x = function (e) {
        ...
        R = /^([^:]+:\/*[^/]*)[\s\S]*$/, M = {
          ...
          return t.space = function (e) {
            ...
            if (t) {
              var n, r, o, i, a, s, l, c, u = t[0], f = t[2], p = f.length > 1,
      ...
      var G = {block: H, inline: K}, Z = x.defaults, J = G.block, X = G.inline, Y = F.repeatString, ee = function () {
          function e(e) {
        ...
        }(), ue = F.merge, fe = F.checkSanitizeDeprecation, pe = F.escape, de = x.getDefaults, he = x.changeDefaults,
        ve = x.defaults;
...
*/
    ...
    e.exports = function e(t, n, A, C) {
      ...
      if (!a(t) && !s(t)) {
        var ae = z(t, P), se = ne ? ne(t) === Object.prototype : t instanceof Object || t.constructor === Object,
